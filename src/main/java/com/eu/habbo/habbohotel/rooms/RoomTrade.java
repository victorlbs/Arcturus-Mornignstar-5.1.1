...
public class RoomTrade {
    ...
    boolean tradeItems() {
        ...
        try (Connection connection = Emulator.getDatabase().getDataSource().getConnection()) {
            ...
            Achievement achievement = Emulator.getGameEnvironment().getAchievementManager().getAchievement("TradeCount");

            if (achievement == null) {
                LOGGER.error("A conquista 'ACH_TradeCount' não foi encontrada!");
            } else {
                AchievementManager.progressAchievement(userTwo.getHabbo().getHabboInfo().getId(), achievement);
                AchievementManager.progressAchievement(userOne.getHabbo().getHabboInfo().getId(), achievement);
            }
