...
public abstract class HabboItem implements Runnable, IEventTriggers {
    ...
    public void onPlace(Room room) {
        ...
        Achievement achievement = Emulator.getGameEnvironment().getAchievementManager().getAchievement("HabboExplorer");

        if (achievement == null) {
            LOGGER.error("A conquista 'HabboExplorer' não foi encontrada!");
        } else {
            AchievementManager.progressAchievement(owner, achievement);
        }
