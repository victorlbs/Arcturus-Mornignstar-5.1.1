...
public class Messenger {
    ...
    public static void checkFriendSizeProgress(Habbo habbo) {
        ...
        Achievement achievementa = Emulator.getGameEnvironment().getAchievementManager().getAchievement("TradingPass7");

        if (achievementa == null) {
            // nada
        } else {
            AchievementManager.progressAchievement(habbo.getHabboInfo().getId(), achievementa);
        }
