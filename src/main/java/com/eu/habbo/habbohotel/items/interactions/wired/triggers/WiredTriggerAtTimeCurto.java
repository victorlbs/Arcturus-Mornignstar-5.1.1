...
public class WiredTriggerAtTimeCurto extends InteractionWiredTrigger implements WiredTriggerReset {
    private static final WiredTriggerType type = WiredTriggerType.AT_GIVEN_TIME;
    public int taskId;
    private int executeTime;

    public WiredTriggerAtTimeCurto(ResultSet set, Item baseItem) throws SQLException {
        super(set, baseItem);
    }

    public WiredTriggerAtTimeCurto(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
    ...
    public void loadWiredData(ResultSet set, Room room) throws SQLException {
        ...
        // Defina um intervalo de tempo entre 50 e 500 milissegundos.
        if (this.executeTime < 50) {
            this.executeTime = 50 * 500;  // Definir o tempo mínimo para 50
        } else if (this.executeTime > 500) {
            this.executeTime = 500 * 500; // Definir o tempo máximo para 500
        }
