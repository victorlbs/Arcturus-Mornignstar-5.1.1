...
public class WiredTriggerAtSetTimeNovo extends InteractionWiredTrigger implements WiredTriggerReset {
    public final static WiredTriggerType type = WiredTriggerType.AT_GIVEN_TIME;

    public int executeTime;
    public int taskId;

    public WiredTriggerAtSetTimeNovo(ResultSet set, Item baseItem) throws SQLException {
        super(set, baseItem);
    }

    public WiredTriggerAtSetTimeNovo(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
    ...
    public void loadWiredData(ResultSet set, Room room) throws SQLException {
        ...
        // Limite de 90 minutos (5400 segundos = 5400000 milissegundos)
        if (this.executeTime < 500) {
            this.executeTime = 20 * 500;
        }

        // Garantir que o executeTime não exceda 90 minutos (5400000 milissegundos)
        if (this.executeTime > 5400000) {
            this.executeTime = 5400000; // 90 minutos em milissegundos
        }
    ...
    public boolean saveData(WiredSettings settings) {
        ...
        // Garantir que o executeTime não exceda 90 minutos
        if (this.executeTime > 5400000) {
            this.executeTime = 5400000;
        }
