...
public class WiredTriggerKick extends InteractionWiredTrigger {
    public static final WiredTriggerType type = WiredTriggerType.WALKS_ON_FURNI;

    private THashSet<HabboItem> items;

    public WiredTriggerKick(ResultSet set, Item baseItem) throws SQLException {
        super(set, baseItem);
        this.items = new THashSet<>();
    }

    public WiredTriggerKick(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
