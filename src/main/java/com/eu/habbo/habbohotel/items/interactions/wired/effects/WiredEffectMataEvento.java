...
public class WiredEffectMataEvento extends InteractionWiredEffect {
    public static final WiredEffectType type = WiredEffectType.SHOW_MESSAGE;

    protected String message = "";

    public WiredEffectMataEvento(ResultSet set, Item baseItem) throws SQLException {
        super(set, baseItem);
    }

    public WiredEffectMataEvento(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
